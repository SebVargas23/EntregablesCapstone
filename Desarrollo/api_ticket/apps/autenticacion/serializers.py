...
class UserCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Usuario  # Usa tu modelo de usuario
    ...
    def create(self, validated_data):
        # Eliminar el campo 'password_confirm' antes de crear el usuario
        ...
        # Crear el usuario usando el método personalizado del UserManager
